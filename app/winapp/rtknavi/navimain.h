...
class TMainForm : public TForm {
 ...
 private:
  void __fastcall UpdateLog(int stat, gtime_t time, double *rr, float *qr, double *rb, int ns,
  ...
  void __fastcall DrawText(TCanvas *c, int x, int y, UTF8String s, TColor color, int ha, int va);
  void __fastcall DrawArrow(TCanvas *c, int x, int y, int siz, int ang, TColor color);
