...
//---------------------------------------------------------------------------
void __fastcall TMainForm::MenuPlotClick(TObject *Sender) { BtnPlotClick(Sender); }
//---------------------------------------------------------------------------
void __fastcall TMainForm::MenuConvClick(TObject *Sender) { BtnConvClick(Sender); }
//---------------------------------------------------------------------------
void __fastcall TMainForm::MenuStrClick(TObject *Sender) { BtnStrClick(Sender); }
//---------------------------------------------------------------------------
void __fastcall TMainForm::MenuPostClick(TObject *Sender) { BtnPostClick(Sender); }
//---------------------------------------------------------------------------
void __fastcall TMainForm::MenuNtripClick(TObject *Sender) { BtnNtripClick(Sender); }
//---------------------------------------------------------------------------
void __fastcall TMainForm::MenuNaviClick(TObject *Sender) { BtnNaviClick(Sender); }
//---------------------------------------------------------------------------
void __fastcall TMainForm::MenuGetClick(TObject *Sender) { BtnGetClick(Sender); }
//---------------------------------------------------------------------------
void __fastcall TMainForm::MenuExitClick(TObject *Sender) { Close(); }
//---------------------------------------------------------------------------
void __fastcall TMainForm::Panel1Resize(TObject *Sender) {
  TSpeedButton *btn[] = {BtnPlot, BtnConv, BtnStr, BtnPost, BtnNtrip, BtnNavi, BtnGet};
  int i, j, k, n, m, h;
  ...
  for (i = k = 0; k < BTN_COUNT; i++)
    for (j = 0; j < n && k < BTN_COUNT; j++, k++) {
