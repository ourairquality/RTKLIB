...
//---------------------------------------------------------------------------
__fastcall TGloFcnDialog::TGloFcnDialog(TComponent *Owner) : TForm(Owner) {
  EnaGloFcn = 0;
...
void __fastcall TGloFcnDialog::FormShow(TObject *Sender) {
  ...
  for (int i = 0; i < 27; i++) {
    if (GloFcn[i])
      GetFcn(i + 1)->Text = text.sprintf("%d", GloFcn[i] - 8);
    else
      GetFcn(i + 1)->Text = "";
  }
  UpdateEnable();
...
void __fastcall TGloFcnDialog::BtnOkClick(TObject *Sender) {
  ...
  for (int i = 0; i < 27; i++) {
    ...
    if (sscanf(text.c_str(), "%d", &no) == 1 && no >= -7 && no <= 6) {
      ...
      GloFcn[i] = 0;  // GLONASS FCN+8 (0:none)
  }
}
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
void __fastcall TGloFcnDialog::EnaFcnClick(TObject *Sender) { UpdateEnable(); }
//---------------------------------------------------------------------------
...
TEdit *__fastcall TGloFcnDialog::GetFcn(int prn) {
  TEdit *fcn[] = {Fcn01, Fcn02, Fcn03, Fcn04, Fcn05, Fcn06, Fcn07, Fcn08, Fcn09,
                  Fcn10, Fcn11, Fcn12, Fcn13, Fcn14, Fcn15, Fcn16, Fcn17, Fcn18,
                  Fcn19, Fcn20, Fcn21, Fcn22, Fcn23, Fcn24, Fcn25, Fcn26, Fcn27};
  return fcn[prn - 1];
}
//---------------------------------------------------------------------------
