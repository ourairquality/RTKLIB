...
//---------------------------------------------------------------------------
__fastcall TMntpOptDialog::TMntpOptDialog(TComponent *Owner) : TForm(Owner) {}
//---------------------------------------------------------------------------
void __fastcall TMntpOptDialog::FormShow(TObject *Sender) {
  TEdit *edit[] = {SrcTbl1, SrcTbl2, SrcTbl3, NULL,     SrcTbl5,  SrcTbl6, SrcTbl7, SrcTbl8,
                   SrcTbl9, NULL,    NULL,    SrcTbl12, SrcTbl13, NULL,    NULL,    SrcTbl16};
  TComboBox *box[] = {NULL, NULL,     NULL,     SrcTbl4, NULL, NULL,     NULL,     NULL,
...
void __fastcall TMntpOptDialog::BtnOkClick(TObject *Sender) {
  ...
  MntpStr = SrcTbl1->Text + ";" + SrcTbl2->Text + ";" + SrcTbl3->Text + ";" + SrcTbl4->Text + ";" +
            ...
            ";" + SrcTbl13->Text + ";" + SrcTbl14->Text + ";" + SrcTbl15->Text + ";" +
            SrcTbl16->Text;
}
//---------------------------------------------------------------------------
