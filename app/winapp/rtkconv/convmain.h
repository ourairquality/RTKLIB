...
class TMainWindow : public TForm {
 ...
 private:
  ...
  TStringList *__fastcall ReadList(TIniFile *ini, AnsiString cat, AnsiString key);
  void __fastcall WriteList(TIniFile *ini, AnsiString cat, AnsiString key, TStrings *list);
