...
//---------------------------------------------------------------------------
__fastcall TCodeOptDialog::TCodeOptDialog(TComponent *Owner) : TForm(Owner) {}
//---------------------------------------------------------------------------
...
void __fastcall TCodeOptDialog::UpdateEnable(void) {
  ...
  C42->Enabled = (NavSys & SYS_CMP) && (FreqType & FREQTYPE_L3);
  C43->Enabled = (NavSys & SYS_CMP) && (FreqType & FREQTYPE_L3);
  C33->Enabled = (NavSys & SYS_CMP) && (FreqType & FREQTYPE_L3);
  ...
  C57->Enabled = (NavSys & SYS_CMP) && (FreqType & FREQTYPE_L4);  //
  C58->Enabled = (NavSys & SYS_CMP) && (FreqType & FREQTYPE_L4);  //
  C26->Enabled = (NavSys & SYS_CMP) && (FreqType & FREQTYPE_L4);  //
  ...
  C30->Enabled = (NavSys & SYS_CMP) && (FreqType & FREQTYPE_L3);  //
