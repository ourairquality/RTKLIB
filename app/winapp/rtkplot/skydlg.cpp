...
//---------------------------------------------------------------------------
__fastcall TSkyImgDialog::TSkyImgDialog(TComponent *Owner) : TForm(Owner) {}
//---------------------------------------------------------------------------
...
void __fastcall TSkyImgDialog::BtnSaveClick(TObject *Sender) {
  ...
  fprintf(fp, "dest    = %.6g %.6g %.6g %.6g %.6g %.6g %.6g %.6g %.6g\n", Plot->SkyDest[1],
          Plot->SkyDest[2], Plot->SkyDest[3], Plot->SkyDest[4], Plot->SkyDest[5], Plot->SkyDest[6],
          Plot->SkyDest[7], Plot->SkyDest[8], Plot->SkyDest[9]);
  fprintf(fp, "elmask  = %d\n", Plot->SkyElMask);
...
//---------------------------------------------------------------------------
void __fastcall TSkyImgDialog::BtnUpdateClick(TObject *Sender) { UpdateSky(); }
//---------------------------------------------------------------------------
void __fastcall TSkyImgDialog::BtnCloseClick(TObject *Sender) { Close(); }
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
void __fastcall TSkyImgDialog::SkyResChange(TObject *Sender) { UpdateSky(); }
//---------------------------------------------------------------------------
