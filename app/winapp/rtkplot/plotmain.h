...
class TPlot : public TForm {
  ...
  void __fastcall DispMouseDown(TObject *Sender, TMouseButton Button, TShiftState Shift, int X,
                                int Y);
  void __fastcall DispMouseUp(TObject *Sender, TMouseButton Button, TShiftState Shift, int X,
                              int Y);
  void __fastcall MouseWheel(TObject *Sender, TShiftState Shift, int WheelDelta, TPoint &MousePos,
                             bool &Handled);
  ...
  void __fastcall DispGesture(TObject *Sender, const TGestureEventInfo &EventInfo, bool &Handled);
 ...
 private:
  ...
  void __fastcall DrawPolyS(TGraph *graph, double *x, double *y, int n, TColor color, int style);
  ...
  void __fastcall CovToXyz(const double *rr, const float *qr, int type, double *xyzs);
  void __fastcall CalcStats(const double *x, int n, double ref, double &ave, double &std,
                            double &rms);
