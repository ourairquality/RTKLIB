...
//---------------------------------------------------------------------------
AboutDialog::AboutDialog(QWidget *parent) : QDialog(parent) { setupUi(this); }

void AboutDialog::showEvent(QShowEvent *event) {
  if (event->spontaneous()) return;

  QPixmap icon[] = {QPixmap(":/icons/rtk1.bmp"), QPixmap(":/icons/rtk2.bmp"),
                    QPixmap(":/icons/rtk3.bmp"), QPixmap(":/icons/rtk4.bmp"),
                    QPixmap(":/icons/rtk5.bmp"), QPixmap(":/icons/rtk6.bmp"),
