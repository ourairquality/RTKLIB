...
class Graph  // graph class
{
 ...
 public:
  ...
  void DrawMark(QPainter &c, const QPoint &p, int mark, const QColor &color, const QColor &bgcolor,
                int size, int rot);
  void DrawMark(QPainter &c, double x, double y, int mark, const QColor &color,
                const QColor &bgcolor, int size, int rot);
  void DrawMarks(QPainter &c, const double *x, const double *y, const QVector<QColor> &colors,
                 int n, int mark, int size, int rot);
  void DrawCircle(QPainter &c, const QPoint &p, const QColor &color, int rx, int ry, int style);
  void DrawCircle(QPainter &c, double x, double y, const QColor &color, double rx, double ry,
                  int style);
  void DrawCircles(QPainter &c, int label);
  void DrawText(QPainter &c, double x, double y, const QString &str, const QColor &color, int ha,
                int va, int rot);
  void DrawText(QPainter &c, double x, double y, const QString &str, const QColor &color, int ha,
                int va, int rot, const QFont &font);
  void DrawText(QPainter &c, const QPoint &p, const QString &str, const QColor &color, int ha,
                int va, int rot);
  void DrawText(QPainter &c, const QPoint &p, const QString &str, const QColor &color, int ha,
                int va, int rot, const QFont &font);
  void DrawText(QPainter &c, double x, double y, const QString &str, const QColor &color,
                const QColor &bgcolor, int ha, int va, int rot);
  void DrawText(QPainter &c, const QPoint &p, const QString &str, const QColor &color,
                const QColor &bgcolor, int ha, int va, int rot);
  ...
  void DrawPatch(QPainter &c, QPoint *p, int n, const QColor &color1, const QColor &color2,
                 int style);
  void DrawPatch(QPainter &c, double *x, double *y, int n, const QColor &color1,
                 const QColor &color2, int style);
  void DrawSkyPlot(QPainter &c, const QPoint &p, const QColor &color1, const QColor &color2,
                   int size);
  void DrawSkyPlot(QPainter &c, double x, double y, const QColor &color1, const QColor &color2,
                   double size);
  void DrawSkyPlot(QPainter &c, const QPoint &p, const QColor &color1, const QColor &color2,
