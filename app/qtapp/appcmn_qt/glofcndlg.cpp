...
void GloFcnDialog::showEvent(QShowEvent*) {
  ...
  for (int i = 0; i < 27; i++) {
    if (GloFcn[i])
      GetFcn(i + 1)->setText(QString::number(GloFcn[i] - 8));
    else
      GetFcn(i + 1)->setText("");
  }
  UpdateEnable();
...
//---------------------------------------------------------------------------
void GloFcnDialog::EnaFcnClick() { UpdateEnable(); }
//---------------------------------------------------------------------------
...
QLineEdit* GloFcnDialog::GetFcn(int prn) {
  QLineEdit* fcn[] = {Fcn01, Fcn02, Fcn03, Fcn04, Fcn05, Fcn06, Fcn07, Fcn08, Fcn09,
