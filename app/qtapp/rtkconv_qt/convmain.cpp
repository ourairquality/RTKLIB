...
extern int showmsg(const char *format, ...) {
  ...
  va_end(arg);
  QMetaObject::invokeMethod(mainWindow->Message, "setText", Qt::QueuedConnection,
...
MainWindow::MainWindow(QWidget *parent) : QMainWindow(parent) {
  ...
  for (i = 0; i <= MAXRCVFMT; i++) Format->addItem(formatstrs[i]);
...
void MainWindow::showEvent(QShowEvent *event) {
  ...
  if (parser.isSet(titleOption)) setWindowTitle(parser.value(titleOption));
}
// callback on form close ---------------------------------------------------
void MainWindow::closeEvent(QCloseEvent *) { SaveOpt(); }
// set output file paths ----------------------------------------------------
void MainWindow::SetOutFiles(const QString &infile) {
  QLineEdit *edit[] = {OutFile1, OutFile2, OutFile3, OutFile4, OutFile5,
                       OutFile6, OutFile7, OutFile8, OutFile9};
...
void MainWindow::BtnPlotClick() {
  ...
  opts << " -r";
  QCheckBox *cb[] = {OutFileEna1, OutFileEna2, OutFileEna3, OutFileEna4,
                     OutFileEna5, OutFileEna6, OutFileEna7, OutFileEna8};
  int i, ena[8];
...
void MainWindow::BtnPostClick() {
  QString cmd1 = CmdPostExe, cmd2 = QString("..\\..\\..\\bin\\") + CmdPostExe,
          cmd3 = QString("..\\rtkpost_qt\\") + CmdPostExe;
  QStringList opts;
  ...
  if (OutFileEna9->isChecked()) opts << " -n \"" + OutFile9->text() + "\"";

  if (TimeStartF->isChecked())
    opts << +" -ts " + dateTime1->dateTime().toString("yyyy/MM/dd hh:mm:ss");
  if (TimeEndF->isChecked())
    opts << " -te " + dateTime2->dateTime().toString("yyyy/MM/dd hh:mm:ss");
...
void MainWindow::BtnOptionsClick() {
  ...
  if (RnxFile != rnxfile) SetOutFiles(InFile->currentText());
  UpdateEnable();
}
//---------------------------------------------------------------------------
void MainWindow::BtnAbortClick() { abortf = 1; }
// callback on button-convert -----------------------------------------------
void MainWindow::BtnConvertClick() { ConvertFile(); }
// callback on button-exit --------------------------------------------------
void MainWindow::BtnExitClick() { close(); }
...
void MainWindow::BtnInFileClick() {
  InFile->setCurrentText(QDir::toNativeSeparators(QFileDialog::getOpenFileName(
      this, tr("Input RTCM, RCV RAW or RINEX File"), QString(),
      tr("All (*.*);;RTCM 2 (*.rtcm2);;RTCM 3 (*.rtcm3);;NovtAtel (*.gps);;ublox "
         "(*.ubx);;SuperStart II (*.log);;"
         "Hemisphere (*.bin);;Javad (*.jps);;RINEX OBS (*.obs *.*O);Septentrio (*.sbf)"))));
  SetOutFiles(InFile->currentText());
}
// callback on output-directory change --------------------------------------
void MainWindow::OutDirChange() { SetOutFiles(InFile->currentText()); }
// callback on button-output-directory --------------------------------------
void MainWindow::BtnOutDirClick() {
  OutDir->setText(QDir::toNativeSeparators(
      QFileDialog::getExistingDirectory(this, tr("Output Directory"), OutDir->text())));
  SetOutFiles(InFile->currentText());
}
...
void MainWindow::BtnOutFile1Click() {
  ...
  OutFile1->setText(QDir::toNativeSeparators(
      QFileDialog::getOpenFileName(this, tr("Output RINEX OBS File"), QString(),
                                   tr("All (*.*);;RINEX OBS (*.obs *.*O);;RINEX NAV (*.nav *.*N "
                                      "*.*P);;RINEX GNAV (*.gnav *.*G);;RINEX HNAV (*.hnav *.*H);;"
                                      "RINEX QNAV (*.qnav *.*Q);;RINEX LNAV (*.lnav *.*L);;RINEX "
                                      "CNAV (*.cnav *.*C);;RINEX INAV (*.inav *.*I);;"
                                      "SBAS Log (*.sbs);;LEX Log (*.lex)"),
                                   &selectedFilter)));
}
...
void MainWindow::BtnOutFile2Click() {
  ...
  OutFile2->setText(QDir::toNativeSeparators(
      QFileDialog::getOpenFileName(this, tr("Output RINEX NAV File"), QString(),
                                   tr("All (*.*);;RINEX OBS (*.obs *.*O);;RINEX NAV (*.nav *.*N "
                                      "*.*P);;RINEX GNAV (*.gnav *.*G);;RINEX HNAV (*.hnav *.*H);;"
                                      "RINEX QNAV (*.qnav *.*Q);;RINEX LNAV (*.lnav *.*L);;RINEX "
                                      "CNAV (*.cnav *.*C);;RINEX INAV (*.inav *.*I);;"
...
void MainWindow::BtnOutFile3Click() {
  ...
  OutFile3->setText(QDir::toNativeSeparators(
      QFileDialog::getOpenFileName(this, tr("Output RINEX GNAV File"), QString(),
                                   tr("All (*.*);;RINEX OBS (*.obs *.*O);;RINEX NAV (*.nav *.*N "
                                      "*.*P);;RINEX GNAV (*.gnav *.*G);;RINEX HNAV (*.hnav *.*H);;"
                                      "RINEX QNAV (*.qnav *.*Q);;RINEX LNAV (*.lnav *.*L);;RINEX "
                                      "CNAV (*.cnav *.*C);;RINEX INAV (*.inav *.*I);;"
...
void MainWindow::BtnOutFile4Click() {
  ...
  OutFile4->setText(QDir::toNativeSeparators(
      QFileDialog::getOpenFileName(this, tr("Output RINEX HNAV File"), QString(),
                                   tr("All (*.*);;RINEX OBS (*.obs *.*O);;RINEX NAV (*.nav *.*N "
                                      "*.*P);;RINEX GNAV (*.gnav *.*G);;RINEX HNAV (*.hnav *.*H);;"
                                      "RINEX QNAV (*.qnav *.*Q);;RINEX LNAV (*.lnav *.*L);;RINEX "
                                      "CNAV (*.cnav *.*C);;RINEX INAV (*.inav *.*I);;"
...
void MainWindow::BtnOutFile5Click() {
  ...
  OutFile5->setText(QDir::toNativeSeparators(
      QFileDialog::getOpenFileName(this, tr("Output RINEX QNAV File"), QString(),
                                   tr("All (*.*);;RINEX OBS (*.obs *.*O);;RINEX NAV (*.nav *.*N "
                                      "*.*P);;RINEX GNAV (*.gnav *.*G);;RINEX HNAV (*.hnav *.*H);;"
                                      "RINEX QNAV (*.qnav *.*Q);;RINEX LNAV (*.lnav *.*L);;RINEX "
                                      "CNAV (*.cnav *.*C);;RINEX INAV (*.inav *.*I);;"
...
void MainWindow::BtnOutFile6Click() {
  ...
  OutFile6->setText(QDir::toNativeSeparators(
      QFileDialog::getOpenFileName(this, tr("Output RINEX LNAV File"), QString(),
                                   tr("All (*.*);;RINEX OBS (*.obs *.*O);;RINEX NAV (*.nav *.*N "
                                      "*.*P);;RINEX GNAV (*.gnav *.*G);;RINEX HNAV (*.hnav *.*H);;"
                                      "RINEX QNAV (*.qnav *.*Q);;RINEX LNAV (*.lnav *.*L);;RINEX "
                                      "CNAV (*.cnav *.*C);;RINEX INAV (*.inav *.*I);;"
...
void MainWindow::BtnOutFile7Click() {
  ...
  OutFile7->setText(QDir::toNativeSeparators(
      QFileDialog::getOpenFileName(this, tr("Output SRINEX CNAVFile"), QString(),
                                   tr("All (*.*);;RINEX OBS (*.obs *.*O);;RINEX NAV (*.nav *.*N "
                                      "*.*P);;RINEX GNAV (*.gnav *.*G);;RINEX HNAV (*.hnav *.*H);;"
                                      "RINEX QNAV (*.qnav *.*Q);;RINEX LNAV (*.lnav *.*L);;RINEX "
                                      "CNAV (*.cnav *.*C);;RINEX INAV (*.inav *.*I);;"
...
void MainWindow::BtnOutFile8Click() {
  ...
  OutFile7->setText(QDir::toNativeSeparators(
      QFileDialog::getOpenFileName(this, tr("Output SBAS/LEX Log File"), QString(),
                                   tr("All (*.*);;RINEX OBS (*.obs *.*O);;RINEX NAV (*.nav *.*N "
                                      "*.*P);;RINEX GNAV (*.gnav *.*G);;RINEX HNAV (*.hnav *.*H);;"
                                      "RINEX QNAV (*.qnav *.*Q);;RINEX LNAV (*.lnav *.*L);;RINEX "
                                      "CNAV (*.cnav *.*C);;RINEX INAV (*.inav *.*I);;"
...
void MainWindow::BtnInFileViewClick() {
  ...
  if ((ext.toLower() == "obs") || (ext.toLower() == "nav") || (ext.mid(1).toLower() == "nav") ||
      (ext.at(2) == 'o') || (ext.at(2) == 'O') || (ext.at(2) == 'n') || (ext.at(2) == 'N') ||
      (ext.at(2) == 'p') || (ext.at(2) == 'P') || (ext.at(2) == 'g') || (ext.at(2) == 'G') ||
      (ext.at(2) == 'h') || (ext.at(2) == 'H') || (ext.at(2) == 'q') || (ext.at(2) == 'Q') ||
      (ext.at(2) == 'l') || (ext.at(2) == 'L') || (ext.at(2) == 'c') || (ext.at(2) == 'C') ||
      (ext.at(2) == 'I') || (ext.at(2) == 'i') || (ext == "rnx") || (ext == "RNX")) {
    viewer->show();
...
void MainWindow::TimeStartFClick() { UpdateEnable(); }
// callback on button-time-end ----------------------------------------------
void MainWindow::TimeEndFClick() { UpdateEnable(); }
// callback on button-time-interval -----------------------------------------
void MainWindow::TimeIntFClick() { UpdateEnable(); }
...
void MainWindow::InFileChange() { SetOutFiles(InFile->currentText()); }
// callback on format change ------------------------------------------------
void MainWindow::FormatChange() { UpdateEnable(); }
// get time -----------------------------------------------------------------
...
QString MainWindow::RepPath(const QString &File) {
  ...
  reppath(qPrintable(File), path, sizeof(path), timeadd(RnxTime, TSTARTMARGIN), qPrintable(RnxCode),
          "");
  return Path = path;
}
// execute command ----------------------------------------------------------
...
void MainWindow::ConvertFile(void) {
  ...
  if (Format->currentIndex() == 0) {  // auto
    ...
    if (formatstrs[i])
      conversionThread->format = i;
    else
      return;
  }
  conversionThread->rnxopt.rnxver = RNXVER[RnxVer];

  if (conversionThread->format == STRFMT_RTCM2 || conversionThread->format == STRFMT_RTCM3 ||
      conversionThread->format == STRFMT_RT17) {
  ...
  if (OutFile1->isEnabled() && OutFileEna1->isChecked())
    strcpy(conversionThread->ofile[0], qPrintable(OutFile1_Text));
  if (OutFile2->isEnabled() && OutFileEna2->isChecked())
    strcpy(conversionThread->ofile[1], qPrintable(OutFile2_Text));
  if (OutFile3->isEnabled() && OutFileEna3->isChecked())
    strcpy(conversionThread->ofile[2], qPrintable(OutFile3_Text));
  if (OutFile4->isEnabled() && OutFileEna4->isChecked())
    strcpy(conversionThread->ofile[3], qPrintable(OutFile4_Text));
  if (OutFile5->isEnabled() && OutFileEna5->isChecked())
    strcpy(conversionThread->ofile[4], qPrintable(OutFile5_Text));
  if (OutFile6->isEnabled() && OutFileEna6->isChecked())
    strcpy(conversionThread->ofile[5], qPrintable(OutFile6_Text));
  if (OutFile7->isEnabled() && OutFileEna7->isChecked())
    strcpy(conversionThread->ofile[6], qPrintable(OutFile7_Text));
  if (OutFile8->isEnabled() && OutFileEna8->isChecked())
    strcpy(conversionThread->ofile[7], qPrintable(OutFile8_Text));
  if (OutFile9->isEnabled() && OutFileEna9->isChecked())
    strcpy(conversionThread->ofile[8], qPrintable(OutFile9_Text));
  ...
  for (i = 0; i < 9; i++) {
    ...
    if (QMessageBox::question(
            this, tr("Overwrite"),
            QString(tr("%1 exists. Do you want to overwrite?")).arg(conversionThread->ofile[i])) !=
        QMessageBox::Yes)
      return;
  }
  GetTime(&conversionThread->rnxopt.ts, &conversionThread->rnxopt.te,
          &conversionThread->rnxopt.tint, &conversionThread->rnxopt.tunit);
  ...
  for (i = 0; i < 2; i++)
    sprintf(conversionThread->rnxopt.comment[i], "%.63s", qPrintable(Comment[i]));
