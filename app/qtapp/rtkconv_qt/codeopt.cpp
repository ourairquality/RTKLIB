...
void CodeOptDialog::updateEnable()
{
    ...
    ui->C26->setEnabled((navSystem & SYS_CMP) && (frequencyType & FREQTYPE_L4));
    ...
    ui->C33->setEnabled((navSystem & SYS_CMP) && (frequencyType & FREQTYPE_L3));
    ...
    ui->C42->setEnabled((navSystem & SYS_CMP) && (frequencyType & FREQTYPE_L3));
    ui->C43->setEnabled((navSystem & SYS_CMP) && (frequencyType & FREQTYPE_L3));
    ui->C56->setEnabled((navSystem & SYS_CMP) && (frequencyType & FREQTYPE_L1));
    ui->C57->setEnabled((navSystem & SYS_CMP) && (frequencyType & FREQTYPE_L4));
    ui->C58->setEnabled((navSystem & SYS_CMP) && (frequencyType & FREQTYPE_L4));
    ...
    ui->C69->setEnabled((navSystem & SYS_CMP) && (frequencyType & FREQTYPE_L3));
    ui->C70->setEnabled((navSystem & SYS_CMP) && (frequencyType & FREQTYPE_L3));
    ui->C35->setEnabled((navSystem & SYS_CMP) && (frequencyType & FREQTYPE_L3));
