...
{
    ui->G01->setEnabled(testsyscode(SYS_GPS, "1C", navSystem, frequencyType));
    ui->G02->setEnabled(testsyscode(SYS_GPS, "1P", navSystem, frequencyType));
    ui->G03->setEnabled(testsyscode(SYS_GPS, "1W", navSystem, frequencyType));
    ui->G04->setEnabled(testsyscode(SYS_GPS, "1Y", navSystem, frequencyType));
    ui->G05->setEnabled(testsyscode(SYS_GPS, "1M", navSystem, frequencyType));
    ui->G06->setEnabled(testsyscode(SYS_GPS, "1N", navSystem, frequencyType));
    ui->G07->setEnabled(testsyscode(SYS_GPS, "1S", navSystem, frequencyType));
    ui->G08->setEnabled(testsyscode(SYS_GPS, "1L", navSystem, frequencyType));
    ui->G12->setEnabled(testsyscode(SYS_GPS, "1X", navSystem, frequencyType));
    ui->G14->setEnabled(testsyscode(SYS_GPS, "2C", navSystem, frequencyType));
    ui->G15->setEnabled(testsyscode(SYS_GPS, "2D", navSystem, frequencyType));
    ui->G16->setEnabled(testsyscode(SYS_GPS, "2S", navSystem, frequencyType));
    ui->G17->setEnabled(testsyscode(SYS_GPS, "2L", navSystem, frequencyType));
    ui->G18->setEnabled(testsyscode(SYS_GPS, "2X", navSystem, frequencyType));
    ui->G19->setEnabled(testsyscode(SYS_GPS, "2P", navSystem, frequencyType));
    ui->G20->setEnabled(testsyscode(SYS_GPS, "2W", navSystem, frequencyType));
    ui->G21->setEnabled(testsyscode(SYS_GPS, "2Y", navSystem, frequencyType));
    ui->G22->setEnabled(testsyscode(SYS_GPS, "2M", navSystem, frequencyType));
    ui->G23->setEnabled(testsyscode(SYS_GPS, "2N", navSystem, frequencyType));
    ui->G24->setEnabled(testsyscode(SYS_GPS, "5I", navSystem, frequencyType));
    ui->G25->setEnabled(testsyscode(SYS_GPS, "5Q", navSystem, frequencyType));
    ui->G26->setEnabled(testsyscode(SYS_GPS, "5X", navSystem, frequencyType));

    ui->R01->setEnabled(testsyscode(SYS_GLO, "1C", navSystem, frequencyType));
    ui->R02->setEnabled(testsyscode(SYS_GLO, "1P", navSystem, frequencyType));
    ui->R14->setEnabled(testsyscode(SYS_GLO, "2C", navSystem, frequencyType));
    ui->R19->setEnabled(testsyscode(SYS_GLO, "2P", navSystem, frequencyType));
    ui->R30->setEnabled(testsyscode(SYS_GLO, "6A", navSystem, frequencyType));
    ui->R31->setEnabled(testsyscode(SYS_GLO, "6B", navSystem, frequencyType));
    ui->R33->setEnabled(testsyscode(SYS_GLO, "6X", navSystem, frequencyType));
    ui->R44->setEnabled(testsyscode(SYS_GLO, "3I", navSystem, frequencyType));
    ui->R45->setEnabled(testsyscode(SYS_GLO, "3Q", navSystem, frequencyType));
    ui->R46->setEnabled(testsyscode(SYS_GLO, "3X", navSystem, frequencyType));
    ui->R66->setEnabled(testsyscode(SYS_GLO, "4A", navSystem, frequencyType));
    ui->R67->setEnabled(testsyscode(SYS_GLO, "4B", navSystem, frequencyType));
    ui->R68->setEnabled(testsyscode(SYS_GLO, "4X", navSystem, frequencyType));

    ui->E01->setEnabled(testsyscode(SYS_GAL, "1C", navSystem, frequencyType));
    ui->E10->setEnabled(testsyscode(SYS_GAL, "1A", navSystem, frequencyType));
    ui->E11->setEnabled(testsyscode(SYS_GAL, "1B", navSystem, frequencyType));
    ui->E12->setEnabled(testsyscode(SYS_GAL, "1X", navSystem, frequencyType));
    ui->E13->setEnabled(testsyscode(SYS_GAL, "1Z", navSystem, frequencyType));
    ui->E24->setEnabled(testsyscode(SYS_GAL, "5I", navSystem, frequencyType));
    ui->E25->setEnabled(testsyscode(SYS_GAL, "5Q", navSystem, frequencyType));
    ui->E26->setEnabled(testsyscode(SYS_GAL, "5X", navSystem, frequencyType));
    ui->E27->setEnabled(testsyscode(SYS_GAL, "7I", navSystem, frequencyType));
    ui->E28->setEnabled(testsyscode(SYS_GAL, "7Q", navSystem, frequencyType));
    ui->E29->setEnabled(testsyscode(SYS_GAL, "7X", navSystem, frequencyType));
    ui->E30->setEnabled(testsyscode(SYS_GAL, "6A", navSystem, frequencyType));
    ui->E31->setEnabled(testsyscode(SYS_GAL, "6B", navSystem, frequencyType));
    ui->E32->setEnabled(testsyscode(SYS_GAL, "6C", navSystem, frequencyType));
    ui->E33->setEnabled(testsyscode(SYS_GAL, "6X", navSystem, frequencyType));
    ui->E34->setEnabled(testsyscode(SYS_GAL, "6Z", navSystem, frequencyType));
    ui->E37->setEnabled(testsyscode(SYS_GAL, "8I", navSystem, frequencyType));
    ui->E38->setEnabled(testsyscode(SYS_GAL, "8Q", navSystem, frequencyType));
    ui->E39->setEnabled(testsyscode(SYS_GAL, "8X", navSystem, frequencyType));

    ui->J01->setEnabled(testsyscode(SYS_QZS, "1C", navSystem, frequencyType));
    ui->J07->setEnabled(testsyscode(SYS_QZS, "1S", navSystem, frequencyType));
    ui->J08->setEnabled(testsyscode(SYS_QZS, "1L", navSystem, frequencyType));
    ui->J09->setEnabled(testsyscode(SYS_QZS, "1E", navSystem, frequencyType));
    ui->J11->setEnabled(testsyscode(SYS_QZS, "1B", navSystem, frequencyType));
    ui->J12->setEnabled(testsyscode(SYS_QZS, "1X", navSystem, frequencyType));
    ui->J13->setEnabled(testsyscode(SYS_QZS, "1Z", navSystem, frequencyType));
    ui->J16->setEnabled(testsyscode(SYS_QZS, "2S", navSystem, frequencyType));
    ui->J17->setEnabled(testsyscode(SYS_QZS, "2L", navSystem, frequencyType));
    ui->J18->setEnabled(testsyscode(SYS_QZS, "2X", navSystem, frequencyType));
    ui->J24->setEnabled(testsyscode(SYS_QZS, "5I", navSystem, frequencyType));
    ui->J25->setEnabled(testsyscode(SYS_QZS, "5Q", navSystem, frequencyType));
    ui->J26->setEnabled(testsyscode(SYS_QZS, "5X", navSystem, frequencyType));
    ui->J33->setEnabled(testsyscode(SYS_QZS, "6X", navSystem, frequencyType));
    ui->J34->setEnabled(testsyscode(SYS_QZS, "6Z", navSystem, frequencyType));
    ui->J35->setEnabled(testsyscode(SYS_QZS, "6S", navSystem, frequencyType));
    ui->J36->setEnabled(testsyscode(SYS_QZS, "6L", navSystem, frequencyType));
    ui->J57->setEnabled(testsyscode(SYS_QZS, "5D", navSystem, frequencyType));
    ui->J58->setEnabled(testsyscode(SYS_QZS, "5P", navSystem, frequencyType));
    ui->J59->setEnabled(testsyscode(SYS_QZS, "5Z", navSystem, frequencyType));
    ui->J60->setEnabled(testsyscode(SYS_QZS, "6E", navSystem, frequencyType));

    ui->S01->setEnabled(testsyscode(SYS_SBS, "1C", navSystem, frequencyType));
    ui->S24->setEnabled(testsyscode(SYS_SBS, "5I", navSystem, frequencyType));
    ui->S25->setEnabled(testsyscode(SYS_SBS, "5Q", navSystem, frequencyType));
    ui->S26->setEnabled(testsyscode(SYS_SBS, "5X", navSystem, frequencyType));

    ui->C02->setEnabled(testsyscode(SYS_BDS3, "1P", navSystem, frequencyType));
    ui->C07->setEnabled(testsyscode(SYS_BDS3, "1S", navSystem, frequencyType));
    ui->C08->setEnabled(testsyscode(SYS_BDS3, "1L", navSystem, frequencyType));
    ui->C12->setEnabled(testsyscode(SYS_BDS3, "1X", navSystem, frequencyType));
    ui->C13->setEnabled(testsyscode(SYS_BDS3, "1Z", navSystem, frequencyType));
    ui->C18->setEnabled(testsyscode(SYS_BDS2, "2X", navSystem, frequencyType) ||
                        testsyscode(SYS_BDS3, "2X", navSystem, frequencyType));
    ui->C26->setEnabled(testsyscode(SYS_BDS3, "5X", navSystem, frequencyType));
    ui->C27->setEnabled(testsyscode(SYS_BDS2, "7I", navSystem, frequencyType));
    ui->C28->setEnabled(testsyscode(SYS_BDS2, "7Q", navSystem, frequencyType));
    ui->C29->setEnabled(testsyscode(SYS_BDS2, "7X", navSystem, frequencyType));
    ui->C33->setEnabled(testsyscode(SYS_BDS2, "6X", navSystem, frequencyType) ||
                        testsyscode(SYS_BDS3, "6X", navSystem, frequencyType));
    ui->C39->setEnabled(testsyscode(SYS_BDS3, "8X", navSystem, frequencyType));
    ui->C40->setEnabled(testsyscode(SYS_BDS2, "2I", navSystem, frequencyType) ||
                        testsyscode(SYS_BDS3, "2I", navSystem, frequencyType));
    ui->C41->setEnabled(testsyscode(SYS_BDS2, "2Q", navSystem, frequencyType) ||
                        testsyscode(SYS_BDS3, "2Q", navSystem, frequencyType));
    ui->C42->setEnabled(testsyscode(SYS_BDS2, "6I", navSystem, frequencyType) ||
                        testsyscode(SYS_BDS3, "6I", navSystem, frequencyType));
    ui->C43->setEnabled(testsyscode(SYS_BDS2, "6Q", navSystem, frequencyType) ||
                        testsyscode(SYS_BDS3, "6Q", navSystem, frequencyType));
    ui->C56->setEnabled(testsyscode(SYS_BDS3, "1D", navSystem, frequencyType));
    ui->C57->setEnabled(testsyscode(SYS_BDS3, "5D", navSystem, frequencyType));
    ui->C58->setEnabled(testsyscode(SYS_BDS3, "5P", navSystem, frequencyType));
    ui->C61->setEnabled(testsyscode(SYS_BDS3, "7D", navSystem, frequencyType));
    ui->C62->setEnabled(testsyscode(SYS_BDS3, "7P", navSystem, frequencyType));
    ui->C63->setEnabled(testsyscode(SYS_BDS3, "7Z", navSystem, frequencyType));
    ui->C64->setEnabled(testsyscode(SYS_BDS3, "8D", navSystem, frequencyType));
    ui->C65->setEnabled(testsyscode(SYS_BDS3, "8P", navSystem, frequencyType));
    ui->C69->setEnabled(testsyscode(SYS_BDS3, "6D", navSystem, frequencyType));
    ui->C70->setEnabled(testsyscode(SYS_BDS3, "6P", navSystem, frequencyType));
    ui->C34->setEnabled(testsyscode(SYS_BDS3, "6Z", navSystem, frequencyType));

    ui->I26->setEnabled(testsyscode(SYS_IRN, "5X", navSystem, frequencyType));
    ui->I49->setEnabled(testsyscode(SYS_IRN, "5A", navSystem, frequencyType));
    ui->I50->setEnabled(testsyscode(SYS_IRN, "5B", navSystem, frequencyType));
    ui->I51->setEnabled(testsyscode(SYS_IRN, "5C", navSystem, frequencyType));
    ui->I52->setEnabled(testsyscode(SYS_IRN, "9A", navSystem, frequencyType));
    ui->I53->setEnabled(testsyscode(SYS_IRN, "9B", navSystem, frequencyType));
    ui->I54->setEnabled(testsyscode(SYS_IRN, "9C", navSystem, frequencyType));
    ui->I55->setEnabled(testsyscode(SYS_IRN, "9X", navSystem, frequencyType));
    ui->I56->setEnabled(testsyscode(SYS_IRN, "1D", navSystem, frequencyType));
    ui->I02->setEnabled(testsyscode(SYS_IRN, "1P", navSystem, frequencyType));
    ui->I12->setEnabled(testsyscode(SYS_IRN, "1X", navSystem, frequencyType));

    if ((navSystem == (SYS_GPS | SYS_GAL | SYS_GLO | SYS_SBS | SYS_BDS | SYS_IRN | SYS_QZS)) &&
