...
static const int sys_tbl[] = {SYS_ALL, SYS_GPS, SYS_GLO, SYS_GAL,
                              SYS_QZS, SYS_CMP, SYS_IRN, SYS_SBS};
...
//---------------------------------------------------------------------------
void MonitorDialog::BtnCloseClick() { accept(); }
//---------------------------------------------------------------------------
...
void MonitorDialog::SelFmtChange(int) {
  ...
  if (ConFmt >= 3 && ConFmt < 18) free_raw(&raw);
  ConFmt = SelFmt->currentIndex();

  if (ConFmt >= 3 && ConFmt < 18) init_raw(&raw, ConFmt - 2);
}
//---------------------------------------------------------------------------
...
void MonitorDialog::ShowRtk(void) {
  ...
  const QString sol[] = {tr("-"),    tr("Fix"),    tr("Float"), tr("SBAS"),
                         tr("DGPS"), tr("Single"), tr("PPP"),   ""};
  const QString mode[] = {tr("Single"),        tr("DGPS"),        tr("Kinematic"),
                          tr("Static"),        tr("Moving-Base"), tr("Fixed"),
                          tr("PPP-Kinematic"), tr("PPP-Static"),  ""};
  ...
  char file[1024] = "";
  const QString ionoopt[] = {
      tr("OFF"),           tr("Broadcast"), tr("SBAS"),     tr("Dual-Frequency"),
      tr("Estimate STEC"), tr("IONEX TEC"), tr("QZSS LEX"), ""};
  const QString tropopt[] = {tr("OFF"),          tr("Saastamoinen"),      tr("SBAS"),
                             tr("Estimate ZTD"), tr("Estimate ZTD+Grad"), ""};
  const QString ephopt[] = {tr("Broadcast"),
                            tr("Precise"),
                            tr("Broadcast+SBAS"),
                            tr("Broadcat+SSR APC"),
                            tr("Broadcast+SSR CoM"),
                            tr("QZSS LEX"),
                            ""};
  ...
  for (i = 0; i < 3; i++)
    for (j = 0; j < 10; j++) nmsg[i][j] = rtksvr.nmsg[i][j];
  ...
  Console->setItem(
      i++, 1,
      new QTableWidgetItem(!rtk.opt.snrmask.ena[0] ? ""
                                                   : QString("%1, %2, %3, %4, %5, %6, %7, %8, %9")
                                                         .arg(rtk.opt.snrmask.mask[0][0], 0)
                                                         .arg(rtk.opt.snrmask.mask[0][1], 0)
                                                         .arg(rtk.opt.snrmask.mask[0][2], 0)
                                                         .arg(rtk.opt.snrmask.mask[0][3], 0)
                                                         .arg(rtk.opt.snrmask.mask[0][4], 0)
                                                         .arg(rtk.opt.snrmask.mask[0][5], 0)
                                                         .arg(rtk.opt.snrmask.mask[0][6], 0)
                                                         .arg(rtk.opt.snrmask.mask[0][7], 0)
                                                         .arg(rtk.opt.snrmask.mask[0][8], 0)));
  ...
  Console->setItem(
      ...
      new QTableWidgetItem(!rtk.opt.snrmask.ena[0] ? ""
                                                   : QString("%1, %2, %3, %4, %5, %6, %7, %8, %9")
                                                         .arg(rtk.opt.snrmask.mask[1][0], 0)
                                                         .arg(rtk.opt.snrmask.mask[1][1], 0)
                                                         .arg(rtk.opt.snrmask.mask[1][2], 0)
                                                         .arg(rtk.opt.snrmask.mask[1][3], 0)
                                                         .arg(rtk.opt.snrmask.mask[1][4], 0)
                                                         .arg(rtk.opt.snrmask.mask[1][5], 0)
                                                         .arg(rtk.opt.snrmask.mask[1][6], 0)
                                                         .arg(rtk.opt.snrmask.mask[1][7], 0)
                                                         .arg(rtk.opt.snrmask.mask[1][8], 0)));
  ...
  Console->setItem(
      ...
      new QTableWidgetItem(!rtk.opt.snrmask.ena[0] ? ""
                                                   : QString("%1, %2, %3, %4, %5, %6, %7, %8, %9")
                                                         .arg(rtk.opt.snrmask.mask[2][0], 0)
                                                         .arg(rtk.opt.snrmask.mask[2][1], 0)
                                                         .arg(rtk.opt.snrmask.mask[2][2], 0)
                                                         .arg(rtk.opt.snrmask.mask[2][3], 0)
                                                         .arg(rtk.opt.snrmask.mask[2][4], 0)
                                                         .arg(rtk.opt.snrmask.mask[2][5], 0)
                                                         .arg(rtk.opt.snrmask.mask[2][6], 0)
                                                         .arg(rtk.opt.snrmask.mask[2][7], 0)
                                                         .arg(rtk.opt.snrmask.mask[2][8], 0)));

  Console->setItem(i, 0, new QTableWidgetItem(tr("Rec Dynamic/Earth Tides Correction")));
  Console->setItem(i++, 1,
                   new QTableWidgetItem(QString("%1, %2")
                                            .arg(rtk.opt.dynamics ? tr("ON") : tr("OFF"))
                                            .arg(rtk.opt.tidecorr ? tr("ON") : tr("OFF"))));

  Console->setItem(i, 0, new QTableWidgetItem(tr("Ionosphere/Troposphere Model")));
  Console->setItem(
      i++, 1,
      new QTableWidgetItem(
          QString("%1, %2").arg(ionoopt[rtk.opt.ionoopt]).arg(tropopt[rtk.opt.tropopt])));
  ...
  Console->setItem(i++, 1,
                   new QTableWidgetItem(QString("%1, %2, %3").arg(nb[0]).arg(nb[1]).arg(nb[2])));

  Console->setItem(i, 0, new QTableWidgetItem(tr("# of Input Data Rover")));
  Console->setItem(
      i++, 1,
      new QTableWidgetItem(
          QString(tr("Obs(%1), Nav(%2), Ion(%3), Sbs (%4), Pos(%5), Dgps(%6), Ssr(%7), Err(%8)"))
              .arg(nmsg[0][0])
              .arg(nmsg[0][1] + nmsg[0][6])
              .arg(nmsg[0][2])
              .arg(nmsg[0][3])
              .arg(nmsg[0][4])
              .arg(nmsg[0][5])
  ...
  Console->setItem(i, 0,
                   new QTableWidgetItem(tr(
                       "Time System Offset/Receiver Bias (GLO-GPS,GAL-GPS,BDS-GPS,IRN-GPS) (ns)")));
  Console->setItem(i++, 1,
                   new QTableWidgetItem(QString("%1, %2, %3, %4")
                                            .arg(rtk.sol.dtr[1] * 1E9, 0, 'f', 3)
                                            .arg(rtk.sol.dtr[2] * 1E9, 0, 'f', 3)
  ...
  Console->setItem(i++, 1,
                   new QTableWidgetItem(QString("%1, %2, %3")
                                            .arg(rtk.sol.rr[0], 0, 'f', 3)
                                            .arg(rtk.sol.rr[1], 0, 'f', 3)
                                            .arg(rtk.sol.rr[2], 0, 'f', 3)));
  ...
  Console->setItem(i++, 1,
                   new QTableWidgetItem(QString("%1, %2, %3")
                                            .arg(rtk.x ? rtk.x[0] : 0, 0, 'f', 3)
                                            .arg(rtk.x ? rtk.x[1] : 0, 0, 'f', 3)
                                            .arg(rtk.x ? rtk.x[2] : 0, 0, 'f', 3)));

  Console->setItem(i, 0, new QTableWidgetItem(tr("Pos X/Y/Z Float Std (m) Rover")));
  Console->setItem(
      i++, 1,
      new QTableWidgetItem(QString("%1, %2, %3")
                               .arg(rtk.P ? SQRT(rtk.P[0]) : 0, 0, 'f', 3)
                               .arg(rtk.P ? SQRT(rtk.P[1 + 1 * rtk.nx]) : 0, 0, 'f', 3)
                               .arg(rtk.P ? SQRT(rtk.P[2 + 2 * rtk.nx]) : 0, 0, 'f', 3)));

  Console->setItem(i, 0, new QTableWidgetItem(tr("Pos X/Y/Z Fixed (m) Rover")));
  Console->setItem(i++, 1,
                   new QTableWidgetItem(QString("%1, %2, %3")
                                            .arg(rtk.xa ? rtk.xa[0] : 0, 0, 'f', 3)
                                            .arg(rtk.xa ? rtk.xa[1] : 0, 0, 'f', 3)
                                            .arg(rtk.xa ? rtk.xa[2] : 0, 0, 'f', 3)));

  Console->setItem(i, 0, new QTableWidgetItem(tr("Pos X/Y/Z Fixed Std (m) Rover")));
  Console->setItem(
      i++, 1,
      new QTableWidgetItem(QString("%1, %2, %3")
                               .arg(rtk.Pa ? SQRT(rtk.Pa[0]) : 0, 0, 'f', 3)
                               .arg(rtk.Pa ? SQRT(rtk.Pa[1 + 1 * rtk.na]) : 0, 0, 'f', 3)
                               .arg(rtk.Pa ? SQRT(rtk.Pa[2 + 2 * rtk.na]) : 0, 0, 'f', 3)));
  ...
  for (j = 0; j < NFREQ; j++) {
    ...
    Console->setItem(i, 0,
                     new QTableWidgetItem(tr("Ant Phase Center L%1 E/N/U (m) Rover").arg(j + 1)));
    Console->setItem(i++, 1,
                     new QTableWidgetItem(QString("%1, %2, %3")
                                              .arg(off[0], 0, 'f', 3)
                                              .arg(off[1], 0, 'f', 3)
  ...
  for (j = 0; j < NFREQ; j++) {
    ...
    Console->setItem(
        i, 0, new QTableWidgetItem(tr("Ant Phase Center L%1 E/N/U (m) Base Station").arg(j + 1)));
    Console->setItem(i++, 1,
                     new QTableWidgetItem(QString("%1, %2, %3")
                                              .arg(off[0], 0, 'f', 3)
                                              .arg(off[1], 0, 'f', 3)
...
void MonitorDialog::SetSat(void) {
  int i, j = 0;
  const QString label[] = {tr("SAT"),      tr("PRN"),           tr("PRN"),
                           tr("Status"),   tr("Azimuth (deg)"), tr("Elevation (deg)"),
                           tr("LG (m)"),   tr("PHW(cyc)"),      tr("P1-P2(m)"),
                           tr("P1-C1(m)"), tr("P2-C2(m)")};
...
void MonitorDialog::ShowSat() {
  ...
  for (i = 0; i < MAXSAT; i++)
    for (j = 0; j < 2; j++) cbias[i][j] = rtksvr.nav.cbias[i][j][0];
  ...
  for (i = 0, n = 0; i < MAXSAT; i++) {
    ...
    for (k = 0; k < nfreq; k++) {
      ...
      Console->setItem(
          n, j++,
          new QTableWidgetItem(
              fix == 1 ? tr("FLOAT") : (fix == 2 ? tr("FIX") : (fix == 3 ? tr("HOLD") : tr("-")))));
    }
    for (k = 0; k < nfreq; k++)
    ...
    Console->setItem(n, j++, new QTableWidgetItem(QString::number(0, 'f', 2)));
    n++;
  }
}
//---------------------------------------------------------------------------
void MonitorDialog::SetEst(void) {
  QString label[] = {tr("State"), tr("Estimate Float"), tr("Std Float"), tr("Estimate Fixed"),
                     tr("Std Fixed")};
...
void MonitorDialog::ShowEst(void) {
  ...
  for (i = 0, n = 1; i < nx; i++) {
    ...
    Console->setItem(i, j++,
                     new QTableWidgetItem(x[i] == 0.0 ? s0 : QString::number(x[i], 'f', 3)));
    Console->setItem(i, j++,
                     new QTableWidgetItem(
                         P[i + i * nx] == 0.0 ? s0 : QString::number(SQRT(P[i + i * nx]), 'f', 3)));
    Console->setItem(i, j++,
                     new QTableWidgetItem((i >= na || qFuzzyCompare(xa[i], 0))
                                              ? s0
                                              : QString::number(xa[i], 'f', 3)));
    Console->setItem(i, j++,
                     new QTableWidgetItem((i >= na || Pa[i + i * na] == 0.0)
                                              ? s0
                                              : QString::number(SQRT(Pa[i + i * na]), 'f', 3)));
    n++;
  }
  free(x);
  free(P);
...
void MonitorDialog::SetCov(void) {
  ...
  for (i = 0; i < 2; i++) Console->setColumnWidth(i, (i == 0 ? 35 : 45) * FontScale / 96);
  Console->setHorizontalHeaderLabels(header);
}
//---------------------------------------------------------------------------
void MonitorDialog::ShowCov(void) {
  ...
  for (i = 0, n = 0; i < nx; i++) {
    ...
    for (j = 0, m = 0; j < nx; j++) {
      ...
      Console->setItem(n, m,
                       new QTableWidgetItem(P[i + j * nx] == 0.0
                                                ? s0
                                                : QString::number(SQRT(P[i + j * nx]), 'f', 5)));
      m++;
    }
    n++;
  }
...
void MonitorDialog::SetObs(void) {
  ...
  for (i = 0; i < NFREQ + nex; i++) {
    ...
    for (i = 0; i < NFREQ + nex; i++) {
      Console->setColumnWidth(j++, 80 * FontScale / 96);
      header << (i < NFREQ ? QString(tr("P%1 (m)")).arg(i + 1)
                           : QString(tr("PX%1 (m)")).arg(i - NFREQ + 1));
    }
    for (i = 0; i < NFREQ + nex; i++) {
      Console->setColumnWidth(j++, 85 * FontScale / 96);
      header << (i < NFREQ ? QString(tr("L%1 (cycle)")).arg(i + 1)
                           : QString(tr("LX%1 (cycle)")).arg(i - NFREQ + 1));
    }
    for (i = 0; i < NFREQ + nex; i++) {
      Console->setColumnWidth(j++, 60 * FontScale / 96);
      header << (i < NFREQ ? QString(tr("D%1 (Hz)")).arg(i + 1)
                           : QString(tr("DX%1 (Hz)")).arg(i - NFREQ + 1));
    }
  }
  for (i = 0; i < NFREQ + nex; i++) {
...
void MonitorDialog::ShowObs(void) {
  ...
  for (i = 0; i < n; i++) {
    ...
    for (k = 0; k < NFREQ + nex; k++) {
      ...
      if (*code)
        Console->setItem(i + 1, j++, new QTableWidgetItem(code));
      else
        Console->setItem(i + 1, j++, new QTableWidgetItem("-"));
    }
    for (k = 0; k < NFREQ + nex; k++) {
      if (obs[i].SNR[k])
        Console->setItem(i + 1, j++,
                         new QTableWidgetItem(QString::number(obs[i].SNR[k] * SNR_UNIT, 'f', 1)));
      else
        Console->setItem(i + 1, j++, new QTableWidgetItem("-"));
    }
    for (k = 0; k < NFREQ + nex; k++) {
      code = code2obs(obs[i].code[k]);
      if (*code)
        Console->setItem(i, j++, new QTableWidgetItem(QString(tr("L%1")).arg(code)));
      else
...
void MonitorDialog::SetNav(void) {
  header.clear();
  header << tr("SAT") << tr("PRN") << tr("Status") << tr("IODE") << tr("IODC") << tr("URA")
         << tr("SVH") << tr("Toe") << tr("Toc") << tr("Ttrans") << tr("A (m)") << tr("e")
         << tr("i0 (deg)") << tr("OMEGA0 (deg)") << tr("omega (deg)") << tr("M0 (deg)")
         << tr("deltan (deg/s)") << tr("OMEGAdot (deg/s)") << tr("IDOT (deg/s)") << tr("af0 (ns)")
         << tr("af1 (ns/s)") << tr("af2 (ns/s2)") << tr("TGD (ns)") << tr("BGD5a (ns)")
         << tr("BGD5b (ns)") << tr("Cuc (rad)") << tr("Cus (rad)") << tr("Crc (m)") << tr("Crs (m)")
         << tr("Cic (rad)") << tr("Cis (rad)") << tr("Code") << tr("Flag");
  int i, width[] = {25, 25, 30, 30, 30, 25, 25, 115, 115, 115, 80, 80, 60, 60, 60, 60,
                    70, 70, 70, 60, 50, 50, 50, 50,  50,  70,  70, 50, 70, 70, 30, 30};
...
void MonitorDialog::ShowNav() {
  ...
  for (k = 0, n = 0; k < MAXSAT; k++) {
    ...
    if (eph[k].iode < 0)
      ...
      s = QString::number(eph[k].iode);
    Console->setItem(n, j++, new QTableWidgetItem(s));
    if (eph[k].iodc < 0)
      s = "-";
    else
      s = QString::number(eph[k].iodc);
    Console->setItem(n, j++, new QTableWidgetItem(s));
    ...
    if (eph[k].toe.time != 0)
      time2str(eph[k].toe, tstr, 0);
    else
      strcpy(tstr, "-");
    Console->setItem(n, j++, new QTableWidgetItem(tstr));
    if (eph[k].toc.time != 0)
      time2str(eph[k].toc, tstr, 0);
    else
      strcpy(tstr, "-");
    Console->setItem(n, j++, new QTableWidgetItem(tstr));
    if (eph[k].ttr.time != 0)
      time2str(eph[k].ttr, tstr, 0);
    else
      strcpy(tstr, "-");
    Console->setItem(n, j++, new QTableWidgetItem(tstr));
...
void MonitorDialog::SetGnav(void) {
  header.clear();
  header << tr("SAT") << tr("PRN") << tr("Status") << tr("IOD") << tr("FCN") << tr("SVH")
         << tr("Age(days)") << tr("Toe") << tr("Tof") << tr("X (m)") << tr("Y (m)") << tr("Z (m)")
         << tr("Vx (m/s)") << tr("Vy (m/s)") << tr("Vz (m/s)") << tr("Ax (m/s2)") << tr("Ay (m/s2)")
         << tr("Az (m/s2)") << tr("Tau (ns)") << tr("Gamma (ns/s)");

  int i, width[] = {25, 25, 30, 30, 30, 25, 25, 115, 115, 75, 75,
                    75, 70, 70, 70, 65, 65, 65, 70,  60,  50};
...
void MonitorDialog::ShowGnav(void) {
  ...
  for (i = 0, n = 0; i < NSATGLO; i++) {
    valid =
        geph[i].toe.time != 0 && !geph[i].svh && fabs(timediff(time, geph[i].toe)) <= MAXDTOE_GLO;
    if (SelSat->currentIndex() == 1 && !valid) continue;
    n++;
  }
  if (n < 2) {
  ...
  for (i = 0, n = 0; i < NSATGLO; i++) {
    ...
    if (geph[i].toe.time != 0)
      time2str(geph[i].toe, tstr, 0);
    else
      strcpy(tstr, "-");
    Console->setItem(n, j++, new QTableWidgetItem(tstr));
    if (geph[i].tof.time != 0)
      time2str(geph[i].tof, tstr, 0);
    else
      strcpy(tstr, "-");
    Console->setItem(n, j++, new QTableWidgetItem(tstr));
...
void MonitorDialog::SetSbsNav(void) {
  header.clear();
  header << tr("SAT") << tr("PRN") << tr("Status") << tr("T0") << tr("Tof") << tr("SVH")
         << tr("URA") << tr("X (m)") << tr("Y (m)") << tr("Z (m)") << tr("Vx (m/s)")
         << tr("Vy (m/s)") << tr("Vz (m/s)") << tr("Ax (m/s2)") << tr("Ay (m/s2)")
         << tr("Az (m/s2)") << tr("af0 (ns)") << tr("af1 (ns/s)");
...
void MonitorDialog::ShowSbsNav(void) {
  ...
  for (int i = 0; i < MAXPRNSBS - MINPRNSBS + 1; i++) {
    ...
    seph[i].pos[0] = seph[i].pos[1] = seph[i].pos[2] = seph[i].vel[0] = seph[i].vel[1] =
        seph[i].vel[2] = seph[i].acc[0] = seph[i].acc[1] = seph[i].acc[2] = seph[i].af0 =
            seph[i].af1 = 0;
  };
  ...
  for (i = 0, n = 0; i < NSATSBS; i++) {
    valid = fabs(timediff(time, seph[i].t0)) <= MAXDTOE_SBS && seph[i].t0.time && !seph[i].svh;
    if (SelSat->currentIndex() == 1 && !valid) continue;
    n++;
  }
  if (n < 1) {
  ...
  for (i = 0, n = 0; i < NSATSBS; i++) {
    ...
    if (seph[i].t0.time)
      time2str(seph[i].t0, tstr, 0);
    else
      strcpy(tstr, "-");
    Console->setItem(i, j++, new QTableWidgetItem(tstr));
    if (seph[i].tof.time)
      time2str(seph[i].tof, tstr, 0);
    else
      strcpy(tstr, "-");
    Console->setItem(i, j++, new QTableWidgetItem(tstr));
...
void MonitorDialog::ShowIonUtc(void) {
  ...
  Console->setItem(i++, 1,
                   new QTableWidgetItem(
                       QString("%1, %2").arg(utc_gps[3], 0, 'f', 0).arg(utc_gps[2], 0, 'f', 0)));

  Console->setItem(i, 0, new QTableWidgetItem(tr("GLOT-UTC Tau, Tau_GPS(ns)")));
  Console->setItem(
      i++, 1,
      new QTableWidgetItem(
          QString("%1,%2").arg(utc_glo[0], 0, 'f', 9).arg(utc_glo[1] * 1E9, 0, 'f', 3)));
  ...
  Console->setItem(i++, 1,
                   new QTableWidgetItem(QString("%1 ,%2")
                                            .arg(utc_gal[3], 0, 'f', 0)
                                            .arg(utc_gal[2], 0, 'f', 0)
                                            .arg(utc_gal[0] * 1e9, 0, 'f', 3)
                                            .arg(utc_gal[1] * 1E9, 0, 'f', 5)));

  Console->setItem(i, 0, new QTableWidgetItem(tr("QZSST-UTC Ref Week, Time(s), A0(ns), A1(ns/s)")));
  Console->setItem(i++, 1,
                   new QTableWidgetItem(tr("%1, %2, %3, %4")
                                            .arg(utc_qzs[3], 0, 'f', 0)
                                            .arg(utc_qzs[2], 0, 'f', 0)
                                            .arg(utc_qzs[0] * 1E9, 0, 'f', 3)
                                            .arg(utc_qzs[1] * 1E9, 0, 'f', 5)));
  Console->setItem(i, 0, new QTableWidgetItem(tr("BDST-UTC Ref Week, Time(s), A0(ns), A1(ns/s)")));
  Console->setItem(i++, 1,
                   new QTableWidgetItem(QString("%1, %2, %3, %4")
                                            .arg(utc_cmp[3], 0, 'f', 0)
                                            .arg(utc_cmp[2], 0, 'f', 0)
                                            .arg(utc_cmp[0] * 1e9, 0, 'f', 3)
                                            .arg(utc_cmp[1] * 1e9, 0, 'f', 5)));

  Console->setItem(
      i, 0, new QTableWidgetItem(tr("IRNT-UTC Ref Week,Time(s), A0(ns), A1(ns/s), A2(ns/s2)")));
  Console->setItem(i++, 1,
                   new QTableWidgetItem(QString("%1, %2, %3, %4")
                                            .arg(utc_irn[3], 0, 'f', 0)
                                            .arg(utc_irn[2], 0, 'f', 0)
                                            .arg(utc_irn[0] * 1e9, 0, 'f', 3)
                                            .arg(utc_irn[1] * 1e9, 0, 'f', 5)));
...
void MonitorDialog::SetStr(void) {
  header.clear();
  header << tr("STR") << tr("Stream") << tr("Type") << tr("Format") << tr("Mode") << tr("State")
         << tr("Input (bytes)") << tr("Input (bps)") << tr("Output (bytes)") << tr("Output (bps)")
         << tr("Path") << tr("Message");
...
void MonitorDialog::ShowStr(void) {
  const QString ch[] = {tr("Input Rover"),       tr("Input Base"),        tr("Input Correction"),
                        tr("Output Solution 1"), tr("Output Solution 2"), tr("Log Rover"),
                        tr("Log Base"),          tr("Log Correction"),    tr("Monitor Port")};
  const QString type[] = {tr("-"),
                          tr("Serial"),
                          tr("File"),
                          tr("TCP Server"),
                          tr("TCP Client"),
                          ...
                          tr("UDP Client"),
                          tr("")};
  const QString outformat[] = {tr("Lat/Lon/Height"), tr("X/Y/Z-ECEF"), tr("E/N/U-Baseline"),
                               tr("NMEA-0183")};
  ...
  for (i = 0; i < 9; i++) {
    ...
    if (!stream[i].type)
      ...
      form = formatstrs[format[i]];
    else if (i < 5 || i == 8)
      form = outformat[format[i]];
    else
      form = "-";
    Console->setItem(i, j++, new QTableWidgetItem(form));
    if (stream[i].mode & STR_MODE_R)
      mode = tr("R");
    else
      mode = "";
...
void MonitorDialog::ShowSbsMsg(void) {
  ...
  const QString content[] = {
      ...
      tr("Fast Corrections"),
      tr("Fast Corrections"),
      tr("Integrity Information"),
      tr("Fast Correction Degradation Factor"),
      tr("GEO Navigation Message"),
      tr("Degradation Parameters"),
      tr("WAAS Network Time/UTC Offset Parameters"),
      tr("GEO Satellite Almanacs"),
      tr("Ionospheric Grid Point Masks"),
      ...
      tr("WAAS Service Messages"),
      tr("Clock-Ephemeris Covariance Matrix Message"),
      tr("Internal Test Message"),
      tr("Null Message"),
      ...
      ""};
  const int id[] = {0,  1,  2,  3,  4,  5,  6,  7,  9,  10, 12, 17, 18, 24,
                    25, 26, 27, 28, 62, 63, 43, 44, 47, 48, 49, 50, 51, -1};
  char tstr[40];
  QString s;
  int i, k, n, prn;
...
void MonitorDialog::SetSbsLong(void) {
  header.clear();
  header << tr("SAT") << tr("Status") << tr("IODE") << tr("dX (m)") << tr("dY (m)") << tr("dZ (m)")
         << tr("dVX (m/s)") << tr("dVY (m/s)") << tr("dVZ (m/s)") << tr("daf0 (ns)")
         << tr("daf1 (ns/s)") << tr("T0");
...
void MonitorDialog::ShowSbsLong(void) {
  ...
  for (i = 0; i < sbssat.nsat; i++) {
    ...
    if (satp->lcorr.t0.time)
      time2str(satp->lcorr.t0, tstr, 0);
    else
      strcpy(tstr, "-");
    Console->setItem(i, j++, new QTableWidgetItem(tstr));
  }
...
void MonitorDialog::SetSbsIono(void) {
  header.clear();
  header << tr("IODI") << tr("Lat (deg)") << tr("Lon (deg)") << tr("GIVEI") << tr("Delay (m)")
         << tr("T0");
...
void MonitorDialog::ShowSbsIono(void) {
  ...
  for (i = 0; i < MAXBAND; i++) {
    ...
    for (j = 0; j < ion->nigp; j++) {
      ...
      Console->setItem(
          n, k++,
          new QTableWidgetItem(ion->igp[j].give ? QString::number(ion->igp[j].give - 1) : s0));
      Console->setItem(n, k++, new QTableWidgetItem(QString::number(ion->igp[j].delay, 'f', 3)));
      if (ion->igp[j].t0.time)
        time2str(ion->igp[j].t0, tstr, 0);
      else
        strcpy(tstr, "-");
...
void MonitorDialog::SetSbsFast(void) {
  header.clear();
  header << tr("SAT") << tr("Status") << tr("PRC (m)") << tr("RRC (m)") << tr("IODF") << tr("UDREI")
         << tr("AI") << tr("Tof");
...
void MonitorDialog::ShowSbsFast(void) {
  ...
  for (i = 0; i < sbssat.nsat; i++) {
    ...
    Console->setItem(
        i, j++,
        new QTableWidgetItem(satp->fcorr.udre ? QString::number(satp->fcorr.udre - 1) : s0));
    Console->setItem(i, j++, new QTableWidgetItem(QString::number(satp->fcorr.ai)));
    if (satp->fcorr.t0.time)
      time2str(satp->fcorr.t0, tstr, 0);
    else
      strcpy(tstr, "-");
    Console->setItem(i, j++, new QTableWidgetItem(tstr));
  }
...
void MonitorDialog::ShowRtcm(void) {
  ...
  Console->setItem(i++, 1,
                   new QTableWidgetItem(format == STRFMT_RTCM2 ? tr("RTCM 2") : tr("RTCM 3")));
...
void MonitorDialog::SetRtcmDgps(void) {
  header.clear();
  header << tr("SAT") << tr("Status") << tr("PRC (m)") << tr("RRC (m)") << tr("IOD") << tr("UDRE")
         << tr("T0");
...
void MonitorDialog::SetRtcmSsr(void) {
  header.clear();
  header << tr("SAT") << tr("Status") << tr("UDI(s)") << tr("UDHR(s)") << tr("IOD") << tr("URA")
         << tr("Datum") << tr("T0") << tr("D0-A(m)") << tr("D0-C(m)") << tr("D0-R(m)")
         << tr("D1-A(mm/s)") << tr("D1-C(mm/s)") << tr("D1-R(mm/s)") << tr("C0(m)")
         << tr("C1(mm/s)") << tr("C2(mm/s2)") << tr("C-HR(m)");
  int i, width[] = {25, 30, 30, 30, 30, 25, 15, 115, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50};

  Console->setColumnCount(20);
  Console->setRowCount(2);
  for (i = 0; i < 18; i++) Console->setColumnWidth(i, width[i] * FontScale / 96);
...
void MonitorDialog::ShowRtcmSsr(void) {
  ...
  for (i = 0; i < n; i++) {
    ...
    for (k = 0; k < 3; k++)
      Console->setItem(i, j++,
                       new QTableWidgetItem(QString::number(ssr[i].ddeph[k] * 1E3, 'f', 3)));
...
void MonitorDialog::ShowRefSta(void) {
  ...
  Console->setItem(i++, 1,
                   new QTableWidgetItem(QString("%1, %2, %3, %4")
                                            .arg(sta.glo_cp_bias[0], 0, 'f', 2)
                                            .arg(sta.glo_cp_bias[1], 0, 'f', 2)
                                            .arg(sta.glo_cp_bias[2], 0, 'f', 2)
                                            .arg(sta.glo_cp_bias[3], 0, 'f', 2)));
}
//---------------------------------------------------------------------------
