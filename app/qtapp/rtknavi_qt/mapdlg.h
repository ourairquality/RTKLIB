...
class MapDialog : public QDialog, private Ui::MapDialog {
 ...
 private:
  ...
  void DrawVertGraph(QPainter &c, const double *sol, const int *stat, int psol, int psols,
                     int psole, int nsol, int currentstat);
  QPoint PosToPoint(const double *pos);
  QPoint PosToGraphP(const double *pos, const double *ref, int index, int npos, QRect rect);
 ...
 public:
  ...
  void ResetRef(void);
  void UpdateMap(const double *sol, const double *solref, const double *vel, const int *stat,
                 int psol, int psols, int psole, int nsol, QString *solstr, int currentstat);
