...
//---------------------------------------------------------------------------
QMarkDialog::QMarkDialog(QWidget *parent) : QDialog(parent) {
  setupUi(this);
  NMark = 1;
...
//---------------------------------------------------------------------------
void QMarkDialog::BtnCancelClick() { close(); }
//---------------------------------------------------------------------------
void QMarkDialog::BtnOkClick() {
  ...
  if (ChkMarkerName->isChecked()) {
    reppath(qPrintable(marker), str2, sizeof(str2), utc2gpst(timeget()),
            qPrintable(QString("%1").arg(NMark, 3, 10, QChar('0'))), "");
...
void QMarkDialog::ChkMarkerNameClick() { UpdateEnable(); }
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
void QMarkDialog::RadioClick() { UpdateEnable(); }
//---------------------------------------------------------------------------
