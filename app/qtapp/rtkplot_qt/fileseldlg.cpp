...
//---------------------------------------------------------------------------
FileSelDialog::FileSelDialog(QWidget *parent) : QDialog(parent) {
  setupUi(this);
  ...
  DirSelector->setWindowFlags(Qt::Window | Qt::X11BypassWindowManagerHint |
...
//---------------------------------------------------------------------------
FileSelDialog::~FileSelDialog() { delete DirSelector; }
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
void FileSelDialog::DirSelSelected(QModelIndex) { DirSelector->setVisible(false); }
//---------------------------------------------------------------------------
