...
//---------------------------------------------------------------------------
MapViewOptDialog::MapViewOptDialog(QWidget *parent) : QDialog(parent) {
  setupUi(this);
...
void MapViewOptDialog::showEvent(QShowEvent *) {
  QLineEdit *titles[] = {MapTitle1, MapTitle2, MapTitle3, MapTitle4, MapTitle5, MapTitle6};
  QLineEdit *tiles[] = {MapTile1, MapTile2, MapTile3, MapTile4, MapTile5, MapTile6};
  for (int i = 0; i < 6; i++) {
