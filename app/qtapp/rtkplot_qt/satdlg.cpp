...
//---------------------------------------------------------------------------
SatDialog::SatDialog(QWidget *parent) : QDialog(parent) {
  setupUi(this);
...
void SatDialog::showEvent(QShowEvent *event) {
  QCheckBox *sat[] = {PRN01, PRN02, PRN03, PRN04, PRN05, PRN06, PRN07, PRN08, PRN09,
                      PRN10, PRN11, PRN12, PRN13, PRN14, PRN15, PRN16, PRN17, PRN18,
                      PRN19, PRN20, PRN21, PRN22, PRN23, PRN24, PRN25, PRN26, PRN27,
                      PRN28, PRN29, PRN30, PRN31, PRN32, SBAS,  GLO,   GAL,   PRN33};
...
//---------------------------------------------------------------------------
void SatDialog::BtnCancelClick() { reject(); }
//---------------------------------------------------------------------------
