...
//---------------------------------------------------------------------------
VecMapDialog::VecMapDialog(QWidget *parent) : QDialog(parent) {
  setupUi(this);
...
void VecMapDialog::BtnColorClick() {
  QPushButton *color[] = {Color1,   Color2,   Color3,   Color4,  Color5,  Color6,  Color7,
                          Color8,   Color9,   Color10,  Color11, Color12, Color1F, Color2F,
                          Color3F,  Color4F,  Color5F,  Color6F, Color7F, Color8F, Color9F,
                          Color10F, Color11F, Color12F, NULL};
  int i;
  ...
  if (color[i]) {
    ...
    color[i]->setStyleSheet(
        QString("QPushButton {background-color: %1;}").arg(color2String(dialog.currentColor())));
...
void VecMapDialog::LayerClick() {
  QRadioButton *layer[] = {Layer1, Layer2, Layer3, Layer4,  Layer5,  Layer6,
...
void VecMapDialog::BtnUpClick() {
  QRadioButton *layer[] = {Layer1, Layer2, Layer3, Layer4,  Layer5,  Layer6,
                           Layer7, Layer8, Layer9, Layer10, Layer11, Layer12};
  QPushButton *color[] = {Color1, Color2, Color3, Color4,  Color5,  Color6,
                          Color7, Color8, Color9, Color10, Color11, Color12};
  QString style;
  QPushButton *colorf[] = {Color1F, Color2F, Color3F, Color4F,  Color5F,  Color6F,
                           Color7F, Color8F, Color9F, Color10F, Color11F, Color12F};
  gisd_t *data;
  char name[256];
  int i, flag;
...
void VecMapDialog::VisClick() {
  QCheckBox *vis[] = {Vis1, Vis2, Vis3, Vis4, Vis5, Vis6, Vis7, Vis8, Vis9, Vis10, Vis11, Vis12};
...
void VecMapDialog::showEvent(QShowEvent *event) {
  ...
  for (int i = 0; i < MAXMAPLAYER; i++) {
    layer[i]->setChecked(false);
    color[i]->setStyleSheet(
        QString("QPushButton {background-color: %1;}").arg(color2String(plot->MapColor[i])));
    colorf[i]->setStyleSheet(
        QString("QPushButton {background-color: %1;}").arg(color2String(plot->MapColor[i])));
  }
  UpdateMap();
}
