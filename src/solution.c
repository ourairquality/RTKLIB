 ...
 *----------------------------------------------------------------------------*/
extern int inputsol(uint8_t data, gtime_t ts, gtime_t te, long double tint, enum solq qflag,
...
/* Read solution data --------------------------------------------------------*/
static bool readsoldata(FILE *fp, gtime_t ts, gtime_t te, long double tint, enum solq qflag,
                        const solopt_t *opt, solbuf_t *solbuf) {
  trace(3, "readsoldata:\n");
