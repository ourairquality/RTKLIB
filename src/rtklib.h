...
EXPORT double code2freq(int sys, enum code code, int fcn);
EXPORT double sat2freq(int sat, enum code code, const nav_t *nav);
...
EXPORT bool readsolt(const char *files[], int nfile, gtime_t ts, gtime_t te, double tint,
...
EXPORT int inputsol(uint8_t data, gtime_t ts, gtime_t te, double tint, enum solq qflag,
